          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" id="editarNombre" name="editarNombre" value="" required autocapitalize="words" oninput="validarTextoEntrada(this, '[a-záéíóúñ ]')">

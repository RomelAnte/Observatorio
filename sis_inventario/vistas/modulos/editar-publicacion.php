...
if(isset($_POST['submit'])!=""){
 ...
 if($move){
  $query=$conn->query("insert into publicaciones(id_usuario,name,fname,codigo,titulo,descripcion)values('$idUsuario','$name','$fname','$codigo','$titulo','$descripcion')");
  if($query){
...
<!-- ================ENTRADA PARA EL CODIGO DE LA PUBLICACION================ -->
                ...
                <div class="col-xs-6">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control input-lg" name="codigo" value="<?php echo $row['codigo']; ?>" id="codigo" readonly>

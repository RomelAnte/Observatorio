  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Evento</h3>
...
<input type="date" class="form-control" id="fecha" value="<?php echo ($fecha);?>" name="fecha" aria-label="..."required>
...
$('#fecha').attr('min', new Date().toISOString().split('T')[0])
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="time" class="form-control" id="hora" value="<?php echo $hora;?>" name="hora" required>
				</div>
			  </div>

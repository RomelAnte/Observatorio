...
$imagen_demo="calen.png";
$insert=mysqli_query($con,"insert into events (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from events order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_banner=intval($rw['last']);
$sql=mysqli_query($con,"select * from events where id='$id_banner' limit 0,1");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar Eventos</h3>
...
<input type="date" class="form-control" id="fecha" value="" name="fecha" aria-label="..."required>
...
$('#fecha').attr('min', new Date().toISOString().split('T')[0])
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="time" class="form-control" id="hora" value="" name="hora" required>

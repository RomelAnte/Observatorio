		 ...
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar Alianzas</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Nombre de la Institución:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Número de Teléfono:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Encargado:</label>
				<div class="col-sm-9">
				...
				<div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Cargo:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">URL Sitio Web:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="orden" class="col-sm-3 control-label" style="text-align: left;">País</label>
				<div class="col-sm-9">
		...
		<div class="col-md-5">
		 ...
		 <!--inicio mensaje de alerta-->
								  ...
								  <div class="alert info">
									  ...
									  Se recomienda subir una Imagen con: 500 x 500 pixeles (4.23 cm de ancho y 4.23 cm de altura).
									</div>

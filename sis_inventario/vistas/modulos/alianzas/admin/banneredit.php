  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Editar Alianza</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  ...
				  <input type="text" class="form-control" id="url_web" value="<?php echo $url_web;?>" required name="url_web"autocapitalize="off" placeholder="Ej: nombredelsitioweb.com">
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <select class="form-control" id="id_pais" required name="id_pais">
					<option value="1" <?php if($id_pais==1){echo "selected";} ?>>Argentina</option>
					<option value="2" <?php if($id_pais==2){echo "selected";} ?>>Colombia</option>
					<option value="3" <?php if($id_pais==3){echo "selected";} ?>>Cuba</option>
					<option value="4" <?php if($id_pais==4){echo "selected";} ?>>Ecuador</option>
				 </select>
				</div>
			  </div>

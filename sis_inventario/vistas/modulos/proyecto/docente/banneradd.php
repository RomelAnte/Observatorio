...
$insert=mysqli_query($con,"insert into proyecto (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from proyecto order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_proyecto=intval($rw['last']);
$sql=mysqli_query($con,"select * from proyecto where id='$id_proyecto' limit 0,1");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Crear Publicación</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  ...
				  <input type="hidden" class="form-control" id="id_proyecto" value="<?php echo intval($id_proyecto);?>" name="id_proyecto">
				</div>
			  </div>
...
<embed src="../img/banner/<?php echo $url_image;?>" type="application/pdf" width="400px" height="400px" />
								  </div>

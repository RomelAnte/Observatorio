...
$(document).ready(function(){
    ...
    e.preventDefault();
    $.ajax({
      url  :"vistas/modulos/banner/upload.php",
      type :"POST",
      cache:false,
  ...
  function fetchData(){
    $.ajax({
      url  : "vistas/modulos/banner/fetch_data.php",
      type : "POST",
      cache: false,
  ...
  $(document).on("click",".btn-success", function(){
    ...
    $.ajax({
      url : "vistas/modulos/banner/edit.php",
      type : "POST",
      cache: false,
      data : {editId:editId},
      success:function(data){
  ...
  $(document).on('click','.delete-btn', function(){
    ...
    if (confirm("¿Está seguro de que desea eliminar esta imagen?")) {
      $.ajax({
        url  : "vistas/modulos/banner/delete.php",
        type : "POST",
        cache:false,
  ...
  $.ajax({
      url  : "vistas/modulos/banner/update.php",
      type : "POST",
      cache: false,
      contentType : false, // you can also use multipart/form-data replace of false
      processData : false,

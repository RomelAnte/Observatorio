...
$insert=mysqli_query($con,"insert into publicacion (url_image, estado) values ('$imagen_demo','0')");
$sql_last=mysqli_query($con,"select LAST_INSERT_ID(id) as last from publicacion order by id desc limit 0,1");
$rw=mysqli_fetch_array($sql_last);
$id_publicacion=intval($rw['last']);
$sql=mysqli_query($con,"select * from publicacion where id='$id_publicacion' limit 0,1");
			...
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  ...
				  <input type="hidden" class="form-control" id="id_publicacion" value="<?php echo intval($id_publicacion);?>" name="id_publicacion">
				</div>
			  </div>

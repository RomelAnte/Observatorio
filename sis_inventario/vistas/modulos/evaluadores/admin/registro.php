      ...
      <div class="row">
		 ...
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Agregar Evaluador</h3>
			<form class="form-horizontal" id="editar_banner">
				...
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Ingrese sus Nombres:</label>
			
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="nombre" value="<?php echo $nombre;?>" required name="nombre" autocapitalize="words" oninput="validarTextoEntrada(this, '[a-záéíóúñ ]')" placeholder="Ej: Bryan Mauricio Yambay Flores" style="text-transform: capitalize;">
...
<!--CAJA PARA LOS NUMEROS INTERNACIONALES-->
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Ingrese un número de Teléfono:</label>
				<div class="col-sm-9">
...
<!--FIN CAJA PARA LOS NUMEROS INTERNACIONALES-->
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Email:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Facebook:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">LinkedIn:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Dirección:</label>
				<div class="col-sm-9">
			  ...
			  <div class="form-group">
				<label for="titulo" class="col-sm-3 control-label" style="text-align: left;">Sobre Mí:</label>
				<div class="col-sm-9">
		 ...
		 <h3 ><span class="glyphicon glyphicon-picture"></span> Imagen</h3>
		  <!--inicio mensaje de alerta-->
								  ...
								  <div class="alert info">
									  ...
									  Se recomienda subir una foto con: 316 x 280 pixeles (2.68 cm de ancho y 2.37cm de altura).
									</div>

...
$insert=mysqli_query($con,"insert into evaluador (url_pdf, estado) values ('$imagen_demo','0')");
		 ...
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Crear Evaluador</h3>
			<form class="form-horizontal" id="editar_banner">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-9">
				  <input type="text" class="form-control" id="telefono" value="<?php echo $telefono;?>" name="telefono" required autocapitalize="words" oninput="validarTextoEntrada(this, '[0-9]+')"
				  placeholder="Ej: 0984614440">
				</div>
			  </div>
				...
				<div class="col-sm-12">
				 ...
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  <div class="fileinput-new thumbnail" style="max-width: 100%;" >
									  <img class="img-rounded" src="../img/banner/<?php echo $url_pdf;?>" />
								  </div>

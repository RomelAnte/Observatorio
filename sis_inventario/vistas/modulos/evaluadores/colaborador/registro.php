...
$pdf_demo="demopdf.png";
$insert=mysqli_query($con,"insert into evaluador (url_image, url_pdf, estado) values ('$imagen_demo','$pdf_demo','0')");
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
		 ...
		 <div class="col-md-7">
		 <h3 ><span class="glyphicon glyphicon-edit"></span> Crear Evaluador</h3>
		...
		<div class="col-md-5">
		 ...
		 <form class="form-vertical">
			<div class="form-group">
				<div class="col-sm-12">
				 <div class="fileinput fileinput-new" data-provides="fileinput">
								  <div class="fileinput-new thumbnail" style="max-width: 60%;" >
									   <embed src="../img/banner/<?php echo $url_pdf;?>" type="application/pdf" width="400px" height="400px" />
								  </div>
								  <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 80px; max-height: 100px;"></div>
								  <div>
									<span class="btn btn-info btn-file"><span class="fileinput-new">Seleccione un Archivo </span>
									<span class="fileinput-exists" onclick="upload_pdf();">Cambiar Archivo</span><input type="file" name="fileToUpload" id="fileToUpload" required onchange="upload_pdf();"></span>
									<a href="#" class="btn btn-danger fileinput-exists" data-dismiss="fileinput">Cancelar</a>
								  </div>
					</div>

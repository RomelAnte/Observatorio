	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "El Contacto se ha borrado correctamente",
	...
	public function ctrDescargarReporte(){
		...
		if(isset($_GET["reporte"])){
			...
			if(isset($_GET["fechaInicial"]) && isset($_GET["fechaFinal"])){
				...
				$contacto = ModeloVentas::mdlRangoFechasVentas($tabla, $_GET["fechaInicial"], $_GET["fechaFinal"]);
				...
				$contacto = ModeloVentas::mdlMostrarVentas($tabla, $item, $valor);
			...
			echo utf8_decode("<table border='0'> 
					...
					<td style='font-weight:bold; border:1px solid #eee;'>ARCHIVO</td>		

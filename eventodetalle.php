        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4">
            ...
            <div class="portfolio-info">
             ...
             <br>
            <div class="portfolio-info">
              <h3>Link del Evento</h3>
              <center>
                <div class="read-more">
                    <a href="<?php echo $row['url_web'];?>" style="display: inline-block; background: #e96b56; color: #fff; padding: 6px 20px; transition: 0.3s; font-size: 14px; border-radius: 4px;"><i class="bx bx-link"></i> Ir al Evento</a>
                </div>
              </center>
            </div>
          </div>

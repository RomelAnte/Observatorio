<?php include "header.php"; ?>
  ...
  <main id="main" style="margin:0 0 50px 0;">
    <?php
          $id=$_GET['id'];
          $result = $db->prepare("SELECT * FROM evaluador where id= :post_id and estado=1");
            ...
            <div class="portfolio-details-slider swiper">
              <div class=" align-items-center">
                ...
                <div class="swiper-slide">
                  <img src="sis_inventario/vistas/modulos/evaluadores/img/banner/<?php echo $row['url_image'];?>" alt="">
                </div>
